...
// Middleware log bandwidth cho mọi response (trừ file stream)
app.use((req, res, next) => {
  ...
  res.send = function (body) {
    ...
    // Log ra console, hoặc lưu vào DB, file, Redis...
    console.log(`[BANDWIDTH] ${req.method} ${req.originalUrl} - ${size} bytes`);
