<template>
  <div class="tw-flex tw-h-screen tw-bg-gray-50 dark:tw-bg-gray-900">
    ...
    <div class="tw-flex-1 tw-flex tw-flex-col">
      ...
      >
        <!-- Tìm kiếm -->
        <div class="tw-flex tw-items-center tw-w-1/3">
        ...
        <div class="tw-relative tw-flex tw-items-center tw-gap-4">
          ...
          <div class="tw-relative" @click="toggleDropdown">
            <User class="tw-w-7 tw-h-7 tw-text-gray-700 dark:tw-text-gray-200 tw-cursor-pointer hover:tw-text-[#086df9]" />
            <div
              v-if="dropdownOpen"
            ...
            >
              ...
              <RouterLink to="/profile" class="tw-flex tw-items-center tw-gap-2 tw-px-4 tw-py-2 hover:tw-bg-gray-100 dark:hover:tw-bg-gray-700 dark:tw-text-gray-200">
